...
export const SubscriptionUnpaidModalStyle: SxProps = {
  ...
  '& .unpaid-loader': { color: ORANGE_DARK },
  '& .unpaid-table-container': { width: '100%', border: `1px solid ${BORDER}`, borderRadius: '10px', overflow: 'hidden' },
  '& .unpaid-table': { bgcolor: WHITE },
  '& .unpaid-table th': {
    fontSize: '11px',
    fontWeight: 700,
    textTransform: 'uppercase',
  ...
  '& .unpaid-table td': { fontSize: '13px', color: TEXT, borderBottom: `1px solid ${alpha(BORDER, 0.4)}`, verticalAlign: 'middle' },
  '& .unpaid-table tbody tr:last-of-type td': { borderBottom: 'none' },
  '& .unpaid-cell-desc': { fontWeight: 600, lineHeight: 1.35, overflowWrap: 'anywhere' },
  '& .unpaid-cell-due': { color: MUTED, whiteSpace: 'nowrap' },
  '& .unpaid-cell-amount': { fontWeight: 700, whiteSpace: 'nowrap' },
  '& .unpaid-item-pay': {
    textTransform: 'none',
    fontWeight: 600,
    bgcolor: ORANGE,

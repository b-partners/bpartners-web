...
const expiredCancelledUser: User = { ...user1, subscription: { status: 'CANCELLED', start: new Date('2025-01-01T00:00:00Z'), end: dayjs().subtract(1, 'day').toDate() } };
const activeCancelledUser: User = { ...user1, subscription: { status: 'CANCELLED', start: new Date('2026-01-01T00:00:00Z'), end: dayjs().add(1, 'year').toDate() } };

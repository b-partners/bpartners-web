...
export const UserAccountsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getAccountHolders(userId: string, accountId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Array<AccountHolder>>>> {
         ...
         * @throws {RequiredError}
         */
        async getAccountsByUserId(id: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Array<Account>>>> {
...
export const UserAccountsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        async getAccountHolders(userId: string, accountId: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Array<AccountHolder>>> {
            return UserAccountsApiFp(configuration).getAccountHolders(userId, accountId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get accounts of a user
        ...
        async getAccountsByUserId(id: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Array<Account>>> {
            return UserAccountsApiFp(configuration).getAccountsByUserId(id, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get a user
        ...
        async getUserById(id: string, options?: AxiosRequestConfig): Promise<AxiosResponse<User>> {
            return UserAccountsApiFp(configuration).getUserById(id, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class UserAccountsApi extends BaseAPI {
    ...
    public async getAccountHolders(userId: string, accountId: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Array<AccountHolder>>> {
        return UserAccountsApiFp(this.configuration).getAccountHolders(userId, accountId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @summary Get accounts of a user
    ...
    public async getAccountsByUserId(id: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Array<Account>>> {
        return UserAccountsApiFp(this.configuration).getAccountsByUserId(id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @summary Get a user
    ...
    public async getUserById(id: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<User>> {
        return UserAccountsApiFp(this.configuration).getUserById(id, options).then((request) => request(this.axios, this.basePath));
    }
}

...
export const PayingApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createTransactionCategories: async (aId: string, tId: string, body?: Array<CreateTransactionCategory>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'aId' is not null or undefined
            if (aId === null || aId === undefined) {
        ...
        getProducts: async (id: string, unique: boolean, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/accounts/{id}/products`
        ...
        getTransactionCategories: async (aId: string, unique: boolean, userDefined?: boolean, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/accounts/{aId}/transactionCategories`
                .replace(`{${"aId"}}`, encodeURIComponent(String(aId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
        ...
        initiatePayments: async (body: Array<PaymentInitiation>, id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/accounts/{id}/paymentInitiations`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
...
export const PayingApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async createProducts(body: Array<CreateProduct>, aId: string, iId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Invoice>>> {
         ...
         * @throws {RequiredError}
         */
        async createTransactionCategories(aId: string, tId: string, body?: Array<CreateTransactionCategory>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Array<TransactionCategory>>>> {
         ...
         * @throws {RequiredError}
         */
        async crupdateInvoice(body: CrupdateInvoice, aId: string, iId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Invoice>>> {
         ...
         * @throws {RequiredError}
         */
        async getInvoiceById(aId: string, iId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Invoice>>> {
         ...
         * @throws {RequiredError}
         */
        async getProducts(id: string, unique: boolean, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Array<Product>>>> {
         ...
         * @throws {RequiredError}
         */
        async getTransactionCategories(aId: string, unique: boolean, userDefined?: boolean, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Array<TransactionCategory>>>> {
         ...
         * @throws {RequiredError}
         */
        async getTransactions(id: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Array<Transaction>>>> {
         ...
         * @throws {RequiredError}
         */
        async initiatePayments(body: Array<PaymentInitiation>, id: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Array<PaymentRedirection>>>> {
...
export const PayingApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        async createProducts(body: Array<CreateProduct>, aId: string, iId: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Invoice>> {
            return PayingApiFp(configuration).createProducts(body, aId, iId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Create transaction categories
         ...
         * @throws {RequiredError}
         */
        async createTransactionCategories(aId: string, tId: string, body?: Array<CreateTransactionCategory>, options?: AxiosRequestConfig): Promise<AxiosResponse<Array<TransactionCategory>>> {
            return PayingApiFp(configuration).createTransactionCategories(aId, tId, body, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Crupdate an invoice
        ...
        async crupdateInvoice(body: CrupdateInvoice, aId: string, iId: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Invoice>> {
            return PayingApiFp(configuration).crupdateInvoice(body, aId, iId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get an invoice
        ...
        async getInvoiceById(aId: string, iId: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Invoice>> {
            return PayingApiFp(configuration).getInvoiceById(aId, iId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get known products of the specified account
        ...
        async getProducts(id: string, unique: boolean, options?: AxiosRequestConfig): Promise<AxiosResponse<Array<Product>>> {
            return PayingApiFp(configuration).getProducts(id, unique, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get known transaction categories of an account
         ...
         * @throws {RequiredError}
         */
        async getTransactionCategories(aId: string, unique: boolean, userDefined?: boolean, options?: AxiosRequestConfig): Promise<AxiosResponse<Array<TransactionCategory>>> {
            return PayingApiFp(configuration).getTransactionCategories(aId, unique, userDefined, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get transactions of an account
        ...
        async getTransactions(id: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Array<Transaction>>> {
            return PayingApiFp(configuration).getTransactions(id, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Initiate payment processes to an account
        ...
        async initiatePayments(body: Array<PaymentInitiation>, id: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Array<PaymentRedirection>>> {
            return PayingApiFp(configuration).initiatePayments(body, id, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class PayingApi extends BaseAPI {
    ...
    public async createProducts(body: Array<CreateProduct>, aId: string, iId: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Invoice>> {
        return PayingApiFp(this.configuration).createProducts(body, aId, iId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @summary Create transaction categories
     ...
     * @memberof PayingApi
     */
    public async createTransactionCategories(aId: string, tId: string, body?: Array<CreateTransactionCategory>, options?: AxiosRequestConfig) : Promise<AxiosResponse<Array<TransactionCategory>>> {
        return PayingApiFp(this.configuration).createTransactionCategories(aId, tId, body, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @summary Crupdate an invoice
    ...
    public async crupdateInvoice(body: CrupdateInvoice, aId: string, iId: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Invoice>> {
        return PayingApiFp(this.configuration).crupdateInvoice(body, aId, iId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @summary Get an invoice
    ...
    public async getInvoiceById(aId: string, iId: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Invoice>> {
        return PayingApiFp(this.configuration).getInvoiceById(aId, iId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @summary Get known products of the specified account
    ...
    public async getProducts(id: string, unique: boolean, options?: AxiosRequestConfig) : Promise<AxiosResponse<Array<Product>>> {
        return PayingApiFp(this.configuration).getProducts(id, unique, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @summary Get known transaction categories of an account
     ...
     * @memberof PayingApi
     */
    public async getTransactionCategories(aId: string, unique: boolean, userDefined?: boolean, options?: AxiosRequestConfig) : Promise<AxiosResponse<Array<TransactionCategory>>> {
        return PayingApiFp(this.configuration).getTransactionCategories(aId, unique, userDefined, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @summary Get transactions of an account
    ...
    public async getTransactions(id: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Array<Transaction>>> {
        return PayingApiFp(this.configuration).getTransactions(id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @summary Initiate payment processes to an account
    ...
    public async initiatePayments(body: Array<PaymentInitiation>, id: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Array<PaymentRedirection>>> {
        return PayingApiFp(this.configuration).initiatePayments(body, id, options).then((request) => request(this.axios, this.basePath));
    }
}

...
export const CustomersApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @param {Array<Customer>} [body]
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    updateCustomers: async (id: string, body?: Array<Customer>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      if (id === null || id === undefined) {
        throw new RequiredError('id', 'Required parameter id was null or undefined when calling updateCustomers.');
      }
      const localVarPath = `/accounts/{id}/customers`.replace(`{${'id'}}`, encodeURIComponent(String(id)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, 'https://example.com');
...
export const CustomersApiFp = function (configuration?: Configuration) {
  return {
    ...
    async updateCustomers(
      ...
      const localVarAxiosArgs = await CustomersApiAxiosParamCreator(configuration).updateCustomers(id, body, options);
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs: AxiosRequestConfig = { ...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url };
        return axios.request(axiosRequestArgs);
      };
  ...
  return {
    ...
    async createCustomers(id: string, body?: Array<CreateCustomer>, options?: AxiosRequestConfig): Promise<AxiosResponse<Array<Customer>>> {
      return CustomersApiFp(configuration)
        .createCustomers(id, body, options)
     ...
     * @throws {RequiredError}
     */
    async updateCustomers(id: string, body?: Array<Customer>, options?: AxiosRequestConfig): Promise<AxiosResponse<Array<Customer>>> {
      return CustomersApiFp(configuration)
        .updateCustomers(id, body, options)
        .then(request => request(axios, basePath));
    },
  };
};
...
export class CustomersApi extends BaseAPI {
   ...
   * @memberof CustomersApi
   */
  public async updateCustomers(id: string, body?: Array<Customer>, options?: AxiosRequestConfig): Promise<AxiosResponse<Array<Customer>>> {
    return CustomersApiFp(this.configuration)
      .updateCustomers(id, body, options)
      .then(request => request(this.axios, this.basePath));
  }

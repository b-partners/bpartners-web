...
export const predefinedFeeTypes = {
  annualTuition1x: {
    type: 'TUITION',
    name: 'Écolage annuel 1x',
    monthlyAmount: 1_600_000,
    monthsNumber: 1,
  },
  annualTuition8x: {
    type: 'TUITION',
    name: 'Écolage annuel 8x',
    monthlyAmount: 250_000,
    monthsNumber: 8,
  },
  annualTuition9x: {
    type: 'TUITION',
    name: 'Écolage annuel 9x',
    monthlyAmount: 200_000,
    monthsNumber: 9,
  },
  biAnnualTuition1x: {
    type: 'TUITION',
    name: 'Écolage semestriel 1x',
    monthlyAmount: 800_000,
    monthsNumber: 1,
  },
  biAnnualTuition4x: {
    type: 'TUITION',
    name: 'Écolage semestriel 4x',
    monthlyAmount: 250_000,
    monthsNumber: 4,
  },
  hardwareConf1_8x: {
    type: 'HARDWARE',
    name: 'Matériel conf1 8x',
    monthlyAmount: 250_000,
    monthsNumber: 8,
  },
  hardwareConf2_8x: {
    type: 'HARDWARE',
    name: 'Matériel conf2 8x',
    monthlyAmount: 200_000,
    monthsNumber: 8,
  },
  entranceExam: {
...
export const predefinedFirstDueDates = { // /!\ note(js-months): months are zero-based in JS
  oct21: {
    name: '15 octobre 2021',
    value: new Date(2021, 9, 15),
  },
  jan22: {
    name: '15 janvier 2022',
    value: new Date(2022, 0, 15),
  },
  apr22: {
    name: '15 avril 2022',
    value: new Date(2022, 3, 15),
  },
};

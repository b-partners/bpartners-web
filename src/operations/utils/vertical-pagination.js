...
export const VerticalPagination = ({ maxSteps, activeStep, setActiveStep, boxSx }) => {
  ...
  return (
    <Box sx={{ ...STYLE, ...boxSx }}>
      <IconButton size='small' onClick={handleNext} disabled={activeStep === maxSteps || maxSteps === 0}>
      ...
      <IconButton size='small' onClick={handleBack} disabled={activeStep === 1 || maxSteps === 0}>

...
export const RebaseEditIcon: FC<RebaseEditIconProps> = ({ slashed = false, ...rest }) => (
  <SvgIcon {...rest}>
    ...
    {slashed && <line x1='3.5' y1='20.5' x2='20.5' y2='3.5' stroke='currentColor' strokeWidth='1.8' strokeLinecap='round' />}
  </SvgIcon>
);

import { ANNOTATION_LABELS_TRANSLATION, ANNOTATION_COVERING_TRANSLATION, ANNOTATION_WEAR_TRANSLATION } from "@/constants"
...
export const translateAnnotationInfo =
  (info: AnnotationInfo & { area: number }): { label: string, value: string }[] => {
    return [

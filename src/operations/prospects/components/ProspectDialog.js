                    ...
                    <Box>
                        <FormControl>
                            ...
                            >
                                {status === 'TO_CONTACT' ? (
                                    <>
                                        <FormControlLabel value='NOT_INTERESTED' control={<Radio size='small'/>}
                                                          label='Pas intéressé' sx={{marginRight: '20px'}}/>
                                        <FormControlLabel value='INTERESTED' control={<Radio size='small'/>}
                                                          label='Intéressé' sx={{marginRight: '20px'}}/>
                                        <FormControlLabel value='PROPOSAL_SENT' control={<Radio size='small'/>}
                                                          label='Devis envoyé' sx={{marginRight: '20px'}}/>
                                    </>
                                ) : (
                                    <>
                                        <FormControlLabel value='PROPOSAL_ACCEPTED' control={<Radio size='small'/>}
                                                          label='Devis accepté' sx={{marginRight: '20px'}}/>
                                        <FormControlLabel value='PROPOSAL_DECLINED' control={<Radio size='small'/>}
                                                          label='Devis refusé' sx={{marginRight: '20px'}}/>
                                        <FormControlLabel value='INVOICE_SENT' control={<Radio size='small'/>}
                                                          label='Facture envoyée' sx={{marginRight: '20px'}}/>
                                    </>
                                )}
                            </RadioGroup>
                            {errors['prospectFeedback'] &&
                                <FormHelperText error>{errors['prospectFeedback'].message}</FormHelperText>}
                        </FormControl>
                    </Box>
                )}
                {status === 'TO_CONTACT' ? (
                    <InvoiceSelection name='invoice' label='resources.invoices.status.proposal'
                                      invoiceTypes={['DRAFT']}/>
                ) : (
                    <InvoiceSelection name='invoice' label='resources.invoices.status.confirmed'
                                      invoiceTypes={['CONFIRMED', 'PAID']}/>
                )}
